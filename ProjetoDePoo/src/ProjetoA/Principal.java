...
import ProjetoA.Venda.PlataformaVendasCarros;
...
public class Principal {
    public static void main(String[] args) {
        ...
        Veiculo carro2 = new Carro("Corolla", "Toyota", 2023, 100500.00);
        plataforma.adicionarCarro(carro1);
        plataforma.adicionarCarro(carro2);

        // Adicionar compradores à plataforma
        Comprador comprador1 = new Comprador("João", "12345678900", 100400.00);
